...
from socket_studio import RaspberrySocket
...
def main():
    ...
    IP_RASP = "192.168.157.194"
    PUERTO = 5000

    rasp_socket = RaspberrySocket(IP_RASP, PUERTO)
    ...
    while True:
        ...
        img,wr,hr = human.drawbbs(img, tracks)

        rasp_socket.send_tracks(tracks,wr,hr)
