...
def show_frame():
    _, frame = cap.read()
    frame = cv2.flip(frame, 1)  # Espejo horizontal de la imagen
...
root.state('zoomed')  # O usar root.attributes('-fullscreen', True) dependiendo del SO
...
listbox_font = font.Font(size=14)  # Aumentar el tamaño de la fuente como sea necesario
